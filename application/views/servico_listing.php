    ...
    <h5 class="card-header">
        <div class="row">
            ...
            <div class="col-sm-4 text-right">
                <?php
                echo anchor('servico/add/', '<span class="btn btn-primary">Adicionar Serviço </span>');
                ?>
            </div>
        </div>
    </h5>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Deseja remover o Serviço: <strong><span id="modalid"></span></strong>
            </div>
...
<script type="text/javascript">
    ...
    $('#999').click(function name(e) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'index.php/servico/delete/' + id,
            success: function() {
                location.reload();
            }
        });
